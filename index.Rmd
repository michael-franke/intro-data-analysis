...
scale_colour_discrete <- function(...) {
  scale_colour_manual(..., values = carto_pal(11, "Vivid"))
}
knitr::opts_chunk$set(warning = FALSE, message = FALSE, cache = TRUE, fig.align = 'center')
...
```{r}
ggplot(iris, aes(x = Sepal.Length, y = Sepal.Width, color = factor(Species))) + geom_point()
```