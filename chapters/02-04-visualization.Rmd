...
The `ggplot` package defines a **layerd grammar of graphs** [@Wickham2010:A-Layered-Gramm]. This is a structured description language for plots (relevant for data science). It uses a smart system of defaults so that it suffices to often just call a convenience wrapper like `geom_point`. But underneath there is the possibility of tinkering with all of the the (layered) elements and to change the defaults if need be. 
