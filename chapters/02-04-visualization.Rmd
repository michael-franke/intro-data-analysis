...
```{r echo = F}
data_KoF_processed <- read_csv(data_KoF_processed, "data_sets/king-of-france_data_processed.csv")
```


```{r, eval = F}
data_KoF_processed <- read_csv(url('https://raw.githubusercontent.com/michael-franke/intro-data-analysis/master/data_sets/king-of-france_data_processed.csv'))
```
