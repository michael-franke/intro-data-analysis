...
This schedule assumes that sections marked as "excursions" are skipped and that lecturers give clear guidance which aspects of each chapter are most important.

```{r ch-01-00-schedule, echo = F}
table_data <- tribble(
  ~week, ~topic, ~chapter,
  1,  "overiew, installation, first steps of R"  , "1 & 2.1",
  2,  "basics of R", "2",
  3,  "data types & wrangling", "3 & 4",
  4,  "summary statistics & plotting", "5 & 6",
  5,  "probability basics", "7" ,
  6,  "models & paramter inference", "8 & 9",
