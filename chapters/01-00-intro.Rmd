...
It's much faster (and less error-prone) if you install devtools and
tidyverse from the app repository via terminal: `apt install
r-cran-devtools r-cran-tidyverse` and continue to the second line in
the R console.
