...
`apt install r-cran-devtools` and continue to the second line in the R
console. If it still doesn't work, you can install the packages needed
manually with `install.packages("tidyverse", "brms", "greta")`