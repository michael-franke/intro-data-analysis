...
There are two options for installing. The simplest method is to
install [VirtualBox](https://virtualbox.org) and use our provided
Ubuntu virtual machine (link provided in class), which has most of the
...
Follow the instructions [here](https://virtualbox.org/download) to
download and install for your platform.

#### Step 2. Download our Ubuntu image

Download this VirtualBox Disk Image and move it into a folder such as
"VMs".
