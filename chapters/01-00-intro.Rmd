...
the background. The following six (hopefully easy) steps describe how
to get the main components installed. Depending on your operating
system (e.g. macOS, Linux, Windows), you might need to follow slightly
different instructions, which are specified.
...
Download the enviroment file from
https://raw.githubusercontent.com/n-kall/IDA2019-package/master/environment.yml
...
Download the requirements file from
https://raw.githubusercontent.com/n-kall/IDA2019-package/master/requirements.txt
...
r-base`. Otherwise, follow the instructions at
https://cran.r-project.org/bin/linux/ubuntu/ for your version.
...
Stan. Otherwise you can install a compiler and toolchain with `apt
...
to install the following from terminal: `apt install libssl-dev
libxml2-dev` and then in the install via the the R console:
