...
in Section \@(Chap-01-00-intro-installation-VirtualBox) is to install
[VirtualBox](https://virtualbox.org) and use our provided Ubuntu
virtual machine (link provided in class), which has the required
software pre-installed and tested. When using this method, you will be
working in an virtualized Linux environment. Alternatively, you can go
through a manual installation tailored to your own OS, as described in
Section \@(Chap-01-00-intro-installation-Manual). Manual installation
is recommended if you do not like to use and virtualized Linux
...
below. Finally, Section \@(Chap-01-00-intro-installation-Manual)
