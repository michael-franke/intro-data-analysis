...
data_BLJM_processed %>% 
  ...
  mutate(
    choice_triple = str_c(BM, "-", LB, "-", JM)
  ) %>% 
  dplyr::count(choice_triple)
```


Figure \@ref(fig:ch-03-04-chi2-model-goodness)

```{r ch-03-04-chi2-model-goodness, echo = F, fig.cap="Graphical representation of Pearson's $\\chi^2$ test for goodness of fit (testing a vector of predicted proportion).", out.width = '40%'}
knitr::include_graphics("visuals/chi2-model-goodness.png")
```

Figure \@ref(fig:ch-03-04-chi2-model-independence)

```{r ch-03-04-chi2-model-independence, echo = F, fig.cap="Graphical representation of Pearson's $\\chi^2$ test for goodness of fit (testing a vector of predicted proportion).", out.width = '40%'}
knitr::include_graphics("visuals/chi2-model-goodness.png")
```
