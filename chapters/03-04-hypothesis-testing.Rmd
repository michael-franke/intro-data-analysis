...
```{r ch-03-04-t-test-model-one-population, echo = F, fig.cap="Graphical representation of the model underlying a frequentist one-population $t$-test. Notice that the lightly shaded node for the standard deviation represents that the value for this parameter is estimated from the data.", out.width = '90%'}
...
```{r ch-03-04-t-test-model-two-populations, echo = F, fig.cap="Graphical representation of the model underlying a frequentist one-population $t$-test. Notice that the light shadeding of the node for the standard deviation and of the node for the mean represents that the values for these parameters are estimated from the data.", out.width = '90%'}
