...
between_group_variance <- 1/2 *             # (1/(k-1)) 
  (
...
within_group_variance <- (n_A + n_B + n_C -3)^(-1) * 
  (
    sum((x_A - mean(x_A))^2) +
    sum((x_B - mean(x_B))^2) +
    sum((x_C - mean(x_C))^2)
