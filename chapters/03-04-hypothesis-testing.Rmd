...
```{r ch-03-04-chi2-model-independence, echo = F, fig.cap="Graphical representation of Pearson's $\\chi^2$ test for goodness of fit (testing a vector of predicted proportion).", out.width = '90%'}
knitr::include_graphics("visuals/chi2-model-independence.png")
```

```{r}
counts_BLJM_choice_pairs_matrix <- matrix(counts_BLJM_choice_pairs_vector, nrow = 2)
chisq.test(counts_BLJM_choice_pairs_matrix, correct = FALSE)
```
