...
Use of `=` is discouraged. You can produce `<-` in RStudio with Option-`-` (on Mac) and Alt-`-` (on Windows) [FILL ME: how on other machines --> see list of "keyboard shortcutes" in notes: 03_other-resources]
...
To comment or uncomment code you can use in RStudio `Command+Shift+C` (on Mac) and `Ctrl+Shift+C` (on Windows).
