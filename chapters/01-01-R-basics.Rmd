...
Create a vector that contains all even numbers from 0 to 20 and assign it to a variable. Now transform the variable such that it contains only odd numbers up to 20 using mathematical operation. Notice that the numbers above 20 should not be included! HINT: you may use indexing to fulfill these criteria.
...
Create a matrix with three columns and three rows that contain random integers from 1 to 100 without replacement. HINT! You may first produce an array with random integers and then pass it to the `matrix()` function.
...
Arrays are simply higher-dimensional matrices. We will not make use of arrays in this book.
...
How many variables should you pass to a function that...
