...
If you are looking for help on a more general topic, use the function `help.search`. It takes a regular expression as input and outputs a list of occurrences in the available documentation. For example, calling the following code might produce a display like in Figure \@ref(fig:R-doc-search-example).
