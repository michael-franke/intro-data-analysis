...
Here's an example of how to perform inference using the MCMC method. Click on the yellowish box to check what the code does and how `Infer()` is used. Please re-visit Chapter \@ref(ch-03-03-MCMC) for more information on MCMC algorithms.
