...
Section \@ref(app-90-01-installation) gives instructions concerning installation of R, RStudio and dependencies for the packages we will use in this course. Section \@ref(app-90-02-reading-material) lists further study material in the form of books, papers, web resources etc.
