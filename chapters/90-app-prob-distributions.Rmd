...
rv_beta_intro <- tibble(
  Q = rbeta(n, shape1 = 1, shape2 = 1),
  X = rbeta(n, shape1 = 4, shape2 = 4),
  Y = rbeta(n, shape1 = 4, shape2 = 2),
  Z = rbeta(n, shape1 = 2, shape2 = 4)
) %>% 
  pivot_longer(cols = c("Q","X", "Y", "Z"), names_to = "parameter_set", values_to = "x")

ggplot(rv_beta_intro, aes(x = x, color = parameter_set)) +
  # draw density lines
  stat_density(geom = "line", position = "identity", size = 2) +
  # add text annotations to lines
  annotate("text", x = 0.5, y = 0.5, label = "X~beta(1,1)", color = project_colors[1], size = 6) +
  annotate("text", x = 0.5, y = 2.50, label = "X~beta(4,4)", color = project_colors[2], size = 6) +
  annotate("text", x = 0.25, y = 2.5, label = "X~beta(4,2)", color = project_colors[3], size = 6) +
  annotate("text", x = 0.75, y = 2.5, label = "X~beta(2,4)", color = project_colors[4], size = 6) +
  # suppress legend
  theme(legend.position = "none") 
...
ggplot(rv_beta_intro, aes(x = x, color = parameter_set)) +
  ...
  ylim(0,1) +
  # add text annotations to lines
  annotate("text", x = 0.80, y = 0.60, label = "X~beta(1,1)", color = project_colors[1], size = 6) +
  annotate("text", x = 0.10, y = 0.25, label = "X~beta(4,4)", color = project_colors[2], size = 6) +
  annotate("text", x = 0.25, y = 0.75, label = "X~beta(4,2)", color = project_colors[3], size = 6) +
  annotate("text", x = 0.75, y = 0.30, label = "X~beta(2,4)", color = project_colors[4], size = 6) +
  # suppress legend
  theme(legend.position = "none")
```
...
rv_uniform_intro <- tibble(
  X = runif(n),
  Y = runif(n, min = 2, max = 4)
) %>% 
  pivot_longer(cols = c("X", "Y"), names_to = "parameter_set", values_to = "x")

ggplot(rv_uniform_intro, aes(x = x, color = parameter_set)) +
  # draw density lines
  stat_density(geom = "line", position = "identity", size = 2) +
  # add text annotations to lines
  annotate("text", x = 0.5, y = 1.25, label = "X~uniform(0,1)", color = project_colors[1], size = 6) +
  annotate("text", x = 3.0, y = 1.25, label = "X~uniform(2,4)", color = project_colors[2], size = 6) +
  # suppress legend
  theme(legend.position = "none") 
...
ggplot(rv_uniform_intro, aes(x = x, color = parameter_set)) +
  ...
  ylim(0,1) +
  # add text annotations to lines
  annotate("text", x = 1.0, y = 0.40, label = "X~uniform(0,1)", color = project_colors[1], size = 6) +
  annotate("text", x = 2.5, y = 0.60, label = "X~uniform(2,4)", color = project_colors[2], size = 6) +
  # suppress legend
  theme(legend.position = "none")
```
