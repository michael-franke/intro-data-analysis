...
ggplot(rv_beta_intro, aes(x = x, color = parameter_set)) +
  ...
  ylim(0,1) +
  # add text annotations to lines
  annotate("text", x = 0.8, y = 0.75, label = "X~beta(1,1)", color = project_colors[1], size = 6) +
  annotate("text", x = 0.51, y = 0.50, label = "X~beta(4,4)", color = project_colors[2], size = 6) +
