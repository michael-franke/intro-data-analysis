...
Examples of some different kinds of variables is shown in Figure \@ref(fig:Ch-02-01-factor-levels) and Table \@ref(tab:CCh-02-01-variable-types-in-R) lists common and/or natural ways of representing different kinds of (data) variables in R.
