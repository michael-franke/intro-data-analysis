...
```{r Ch-02-01-exam-results-untidy, echo = T}
...
Any data set that is not tidy is **messy data**. Messy data that satisfies the first two contraints, but not the third will be called **almost tidy data** in this course. We will work, wherever possible, with data that is at least almost tidy.

<!-- TODO: explain difference between truly tidy and almost tidy -->
<!-- TODO: insert picture of tidy data -->
...
To bring your data into a tidy format, or an almost tidy format, you will usually want to perform a step of **data pre-processing**. The next chapter describes the tools for doing this.
