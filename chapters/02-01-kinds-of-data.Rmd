...
Some say we live in the **data age**. But what is data actually? Purist pedants say: "The plural of datum" and add that a datum is just an observation. But when we say "data", we usually mean a bit more than a bunch of observations. The Merriam-Webster offers the following definition:
...
<!-- tribble( -->
<!--   ~name,    ~age,   ~gender,    ~handedness, ~height, ~education,    ~"pets?", ~mood, -->
...
<!-- <div align = "right">Solutions are in Appendix \@ref(app-98-solutions-exercises-Ch3-Ex1)</div> -->
<!-- </div> -->
...
<!-- ### Exercise 1 {#app-98-solutions-exercises-Ch3-Ex1} -->
...
<!-- `name`: nominal variable <br /> -->
<!-- `age`: metric variable <br /> -->
<!-- `gender`: nominal variable <br /> -->
<!-- `handedness`: binary variable <br /> -->
<!-- `height`: metric variable <br /> -->
<!-- `education`: ordinal variable <br /> -->
<!-- `pets?`: Boolean variable <br /> -->
...
<!-- d. What is the dependent variable (if any), what is the independent variable (if any)? -->
<!-- e. Is this experiment a repeated measures design? Explain your answer. -->

<!-- <div align = "right">Solutions are in Appendix \@ref(app-98-solutions-exercises-Ch3-Ex2)</div> -->
<!-- </div> -->

<!-- TODO ÖÖ: after checked, paste solutions below in Appendix E -->

<!-- ### Exercise 2 {#app-98-solutions-exercises-Ch3-Ex2} -->
...
<!-- a. Is this experiment a one-factor or a full factorial design? What is/are the factor(s)? How many levels does each factor have? <br /> -->
<!--    <span style="color:firebrick">SOLUTION:</span> This experiment is a $3 \times 2$ full factorial design. It has two factors, `caffeine` (levels: none, medium, high) and `time of day` (levels: morning, afternoon).  -->

<!-- b. How many experimental conditions are there? <br /> -->
<!--    <span style="color:firebrick">SOLUTION:</span> There are `3 * 2 = 6` different experimental conditions. -->

<!-- c. Is it a between- or within-subjects design? <br /> -->
<!--    <span style="color:firebrick">SOLUTION:</span> Within-subjects design (each participant contributes data to *all* experimental conditions). -->

<!-- d. What is the dependent variable (if any), what is the independent variable (if any)? <br /> -->
<!--    <span style="color:firebrick">SOLUTION:</span> <br /> -->
...
<!-- e. Is this experiment a repeated measures design? Explain your answer. <br /> -->
<!--    <span style="color:firebrick">SOLUTION:</span> No, each participant contributes exactly one data point per design cell. -->
