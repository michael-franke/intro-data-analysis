...
What should be in empty spaces to write the likelihood function in R.
...
You want to check if a coin is fair. You toss it 100 times and 22 times get heads. Now you can compute if likelihood (p==0.5) is accurate for it. Try it out in your R console!
...
d. In a Linear Regression Model $y_i$ id determined by it's underlying distribution.
