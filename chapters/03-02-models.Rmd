...
When we have several observations, like in the avocado price data set, we use indexed variables. For exmple, the likelihood function handled in Section \@ref(hap-03-03-models-general) for modeling avocado prices as a function the type of avocado was previously written like so:
...
```{r ch-03-02-Linear-Regression-Groups, echo = F, out.width = '70%', fig.cap="The Linear Regression with Two Groups Model."}
