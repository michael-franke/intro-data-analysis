...
The symbol "$\sim$" is often read as "is distributed as". You can also think of it as meaning that $\theta_c$ is sampled from a $\text{Beta}(1,1)$ distribution distribution.
