...
```{r ch-03-02-FlipDraw-Model, echo = F, fig.cap="The Flip-and-Draw Model.", out.width = '50%'}
...
```{r ch-03-02-FlipDraw-Hypergeometric, echo = F, fig.cap="The Flip-and-Draw-Hypergeometric Model."}
