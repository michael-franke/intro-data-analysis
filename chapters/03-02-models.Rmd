...
Of these $N$ and $k$ are observed and discrete variables, and $\theta$ is a latent continuous variable. Clearly,the number of heads $k$ depends on the coin bias $\theta$ as well as on the number of trials $N$. This yields a graphical and formulaic notation as in Figure \@ref(ch-03-02-Binomial-Model).

```{r ch-03-02-Binomial-Model, echo = F, fig.cap="The Binomial Model.", out.width = '30%'}
...
```{r ch-03-02-FlipDraw-Hypergeometric, echo = F, out.width = '70%', fig.cap="The Flip-and-Draw-Hypergeometric Model."}
