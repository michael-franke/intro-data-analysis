...
* Values of $\alpha_i<1$ can be thought as anti-weight that pushes away $x_i$ toward extremes (see top left plot).
* If $\alpha_1=...=\alpha_k=1$, then the points are uniformly distributed (see top right plot).
* Higher values of $\alpha_i$ lead to greater "weight" of $X_i$ and a greater amount of the total "mass" assigned to it (see bottom left plot). 
* If all $\alpha_i$ are equal, the distribution is symmetric (see bottom right plot for an asymmetric plot).
