...
* Values of $\alpha_i<1$ can be thought as anti-weight that push away $x_i$ toward extremes (see upper left panel of Figure \@ref(fig:ch-app-01-dirichlet-distribution-density)).
