...
```{r ch-app-01-normal-distribution-shiny, fig.cap="App taken from http://www.artofstat.com/webapps.html"}
...
```{r ch-app-01-chi-squared-distribution-shiny, fig.cap="App taken from http://www.artofstat.com/webapps.html"}
...
```{r ch-app-01-F-distribution-shiny, fig.cap="App taken from http://www.artofstat.com/webapps.html"}
...
```{r ch-app-01-t-distribution-shiny, fig.cap="App taken from http://www.artofstat.com/webapps.html"}
...
```{r ch-app-01-binomial-distribution-shiny, fig.cap="App taken from http://www.artofstat.com/webapps.html"}
...
```{r ch-app-01-poisson-distribution-shiny, fig.cap="App taken from http://www.artofstat.com/webapps.html"}
