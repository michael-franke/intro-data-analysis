...
plot_grid(p1,p2, labels = c("RV ~ t(2)","RV ~ std.norm/sqrt(chi/2)"))
```

```{r r ch-app-01-random-variables-F-distribution, fig.cap = "Create F-distributed random variable by divison of chi-squared RV by (another independent) chi-squared RV"}
...
plot_grid(p1,p2, labels = c("RV ~ F(2,3)","RV ~ (rv_chi_1/2)/(rv_chi_2/3)"), label_size = 10)
```