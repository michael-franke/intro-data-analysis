...
<!-- 3. Decide for the following two statements whether they are true or false: -->
...
<!-- <div align = "right">Solutions are in Appendix \@ref(app-98-solutions-exercises-Ch5-Ex1)</div> -->
<!-- </div> -->
...
<!-- ### Exercise 1 {#app-98-solutions-exercises-Ch5-Ex1} -->

<!-- 1. Compute the mean, median and mode of data vector $\vec{x} = \langle1,2,4,10\rangle$. <br /> -->
...
<!-- 2. Now add two numbers to the vector such that the median stays the same, but mode and mean change. <br /> -->
<!--    <span style="color:firebrick">SOLUTION:</span> <br /> -->
...
<!-- 3. Decide for the following two statements whether they are true or false: -->
<!--    a. <span style="background-color: #b3ffcc">The mean is a measure of central tendency, which can be quite sensitive to even single outliers in the data.</span> -->
<!--    b. <span style="background-color: #b3ffcc">If $\vec{x}$ is a vector of binary Boolean outcomes, we can retrieve the proportion of occurrences of TRUE in $\vec{x}$ by the R function `mean(x)`.</span> -->
<!--    <br /> -->
<!--    <br /> -->
...
<!--   stat_function(fun = dnorm, args = list(mean = -6, sd = 0.5), color = "purple", size = 2) + -->
...
<!-- <div align = "right">Solutions are in Appendix \@ref(app-98-solutions-exercises-Ch5-Ex2)</div> -->
<!-- </div> -->

<!-- TODO ÖÖ: after checked, paste solutions below in Appendix E -->

<!-- ### Exercise 2 {#app-98-solutions-exercises-Ch5-Ex2} -->

<!-- 1. Compute the unbiased variance and standard deviation of data vector $\vec{y} = \langle4,2,6,8\rangle$ <br /> -->
<!--    <span style="color:firebrick">SOLUTION:</span> <br /> -->
<!--    $$ -->
<!--    \mu_{\vec{y}} = \frac{4+2+6+8}{4}=5\\ -->
<!--    Var(\vec{y}) = \frac{1}{n-1}\sum_{i = 1}^n (y_i-\mu_{\vec{y}})^2\\ -->
<!--    Var(\vec{y}) = \frac{1}{4-1}((4-5)^2+(2-5)^2+(6-5)^2+(8-5)^2) =\\ -->
...
<!-- &emsp;&emsp;&ensp; <span style="color:firebrick">SOLUTION:</span> <br /> -->

<!-- <ul style="margin-left: 2em;"> -->
<!--   <li>Distribution 1: larger mean, same standard deviation</li> -->
<!--   <li>Distribution 2: same mean, larger standard deviation</li> -->
<!--   <li>Distribution 3: larger mean, larger standard deviation</li> -->
<!--   <li>Distribution 4: smaller mean, smaller standard deviation</li> -->
<!-- </ul> -->

<!-- &emsp;&emsp;&ensp; Concretely, we used the following parameters $\mu$ and $\sigma$: <br /> -->

<!-- <ul style="margin-left: 2em;"> -->
<!--   <li>Distribution 1: $\mu$ = 5, $\sigma$ = 1</li> -->
<!--   <li>Distribution 2: $\mu$ = 0, $\sigma$ = 3</li> -->
<!--   <li>Distribution 3: $\mu$ = 6, $\sigma$ = 2</li> -->
<!--   <li>Distribution 4: $\mu$ = -6, $\sigma$ = 0.5</li> -->
<!-- </ul> -->

<!-- 3. Decide for the following statements whether they are true or false: -->
<!--    a. <span style="background-color: #b3ffcc">The median is the 50% quantile.</span> -->
<!--    b. A 10% quantile of 0.2 indicates that 10% of the data observations are above 0.2. -->
<!--    c. <span style="background-color: #b3ffcc">The 85% quantile of a vector with unequal numbers always has a larger value than the 25% quantile.</span> -->
<!--    <br /> -->
<!--    <br /> -->
<!--    <font size="1">Correct answers are highlighted.</font> -->
...
<!-- 1. Explain in your own words, how the bootstrapping-algorithm to obtain the 95% confidence interval of the mean works (2-3 sentences). -->
...
<!-- <div align = "right">Solutions are in Appendix \@ref(app-98-solutions-exercises-Ch5-Ex3)</div> -->
<!-- </div> -->

<!-- TODO ÖÖ: after checked, paste solutions below in Appendix E -->

<!-- ### Exercise 3 {#app-98-solutions-exercises-Ch5-Ex3} -->

<!-- 1. Explain in your own words, how the bootstrapping-algorithm to obtain the 95% confidence interval of the mean works (2-3 sentences). <br /> -->
   <!-- <span style="color:firebrick">SOLUTION:</span> To get the 95% CI of the mean, we repeatedly take samples from a data vector (with replacement) and calculate the mean of each sample. After taking $k$ samples and calculating each mean $\mu$, we get a vector of means $\mu_{sampled}$. The 95% CI ranges between the boundaries of the 95% inner quantile of $\mu_{sampled}$ -->

<!-- 2. Decide for the following statements whether they are true or false: -->
<!--    a. The more samples we take from our data, the larger the 95% confidence interval gets. -->
<!--    b. <span style="background-color: #b3ffcc">A larger 95% confidence interval of the mean indicates higher uncertainty regarding the mean.</span> -->
   <!-- c. <span style="background-color: #b3ffcc">The 95% confidence interval of the mean contains 95% of the values of $\mu_{sampled}$.</span> -->
<!--    <br /> -->
<!--    <br /> -->
<!--    <font size="1">Correct answers are highlighted.</font> -->
...
<!-- <div align = "right">Solutions are in Appendix \@ref(app-98-solutions-exercises-Ch5-Ex4)</div> -->
<!-- </div> -->

<!-- TODO ÖÖ: after checked, paste solutions below in Appendix E -->

<!-- ### Exercise 4 {#app-98-solutions-exercises-Ch5-Ex4} -->

<!-- 1. Given two vectors of paired metric measurements $\vec{x}$ and $\vec{y}$, you are given the covariance $Cov(\vec{x},\vec{y})$ = 1 and the variance of each vector $Var(\vec{x})$ = 25 and $Var(\vec{y})$ = 36. Compute Pearson’s correlation coefficient for $\vec{x}$ and $\vec{y}$.<br /> -->
...
<!--    a. The covariance is bounded between -100 and 100. -->
<!--    b. The Pearson correlation coefficient is bounded between 0 and 1. -->
<!--    c. <span style="background-color: #b3ffcc">For any (non-trivial) vector $\vec{x}$ of metric measurements, $Cor(\vec{x},\vec{x})$ = 1.</span> -->