...
<!-- 1. Explain in your own words, how the bootstrapping-algorithm to obtain the 95% confidence interval of the mean works (2-3 sentences). <br /> -->
   <!-- <span style="color:firebrick">SOLUTION:</span> To get the 95% CI of the mean, we repeatedly take samples from a data vector (with replacement) and calculate the mean of each sample. After taking $k$ samples and calculating each mean $\mu$, we get a vector of means $\mu_{sampled}$. The 95% CI ranges between the smallest and largest value of the 95% inner quantile of $\mu_{sampled}$. -->
...
<!-- 2. Decide for the following statements whether they are true or false: -->
<!--    a. The covariance is bound between -100 and 100. -->
<!--    b. The Pearson correlation coefficient is bound between 0 and 1. -->
