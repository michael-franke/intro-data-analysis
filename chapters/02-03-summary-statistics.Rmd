...
Chapter \@ref(Chap-02-03-summary-statistics-counts) first looks at a very intuitive class of summary statistics for categorical data, namely counts and proportions.
...
Chapter \@ref(Chap-02-03-summary-statistics-2D) looks at measures of relation between two numerical vectors, namely *covariance* and *correlation*.
...
Very familiar instances of summary statistics are counts and frequencies.
