...
The frequentst approach does not offer a direct and intuitively interpretable measure of evidence in favor of the null-hypothesis.
...
The main objection against Bayesianism which motivated and still drives the frequentist program is that Bayesian priors are *subjective*, and therefore to be regarded as less unscientific than hard *objectively justifiable* ingredients, such as likelihood functions.
