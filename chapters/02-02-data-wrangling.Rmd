...
<!-- # Solution:  -->
<!-- # This data is not tidy for given reasons:  -->
<!-- # 1.	A row contains more than one observation.  -->
<!-- #2.	A field doescontain more than one value.  -->
<!-- ``` -->
...
<!-- ```{r} -->
<!-- #  This time we are working with the example given earlier -->
<!-- #data <- tribble( -->
<!--  # ~subject_id,  ~choices,  ~reaction_times, -->
<!--  # 1,            "A,B,B",   "312 433 365", -->
<!--  # 2,            "B,A,B",   "393 491 327", -->
...
<!-- #  4,            "A,B,B",   "292 352 378" -->
<!-- #) -->
<!-- # Take a look at the following code snippet. Explain What each of the parts (indicated by the numbers) do. What will the result look like -->
<!-- #choice_data <- data %>%  -->
<!-- ##1 -->
...
<!-- #    values_to = "response") -->
<!-- #Solution -->
<!-- # 1. Selecting the two columns (subject_id and choices) out of the data set -->
<!-- # 2. In the data set each cell in the choices column contains more than one value. In order to seperate them, we take this colum and divide the strings by the ",". The names are then given from one to three for each row. -->
...
But then we need to do that two more times, as we shouldn't copy-paste code, we write a function and use `mutate` to add a mean for each student:
