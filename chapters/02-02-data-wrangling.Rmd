...
This data is "too wide". We can make it wider with `pivot_longer`:
...
To bring your data into a tidy format, or an almost tidy format, you will usually want to perform a step of **data pre-processing**. 
