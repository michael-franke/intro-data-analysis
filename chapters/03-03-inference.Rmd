...
b. Compute the proportion of the posterior value of the new proposal and the height of the posterior at the previous step.
...
f. If the new proposal has a lower posterior value than the most recent sample, then 
