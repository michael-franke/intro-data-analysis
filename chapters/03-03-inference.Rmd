...
RT_goNoGo <- mc_data_cleaned %>% filter(group == "goNoGo") %>% pull(RT)
RT_discrm <- mc_data_cleaned %>% filter(group == "discrimination") %>% pull(RT)
...
draws <- greta::mcmc(m, warmup = 2000, n_samples = 4000)
```
