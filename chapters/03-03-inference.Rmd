...
```{r ch-03-03-estimation-sequential-updates, echo = fig.cap = "Beta distributions for different parameters. Starting from an uninformative prior (top left), we arrive at the posterior distribution in the bottom left, in any sequence of sequentially updating with the data.", fig.height = 8}
expand_grid(
...
This sequential updating is not a peculiarity of the Beta-Binomial case or of conjugacy. It holds in general for Bayesian inference, and it is a very intuitive property which is not shared by all other forms of inference from data.
