...
We save this Stan code in a file `binomial_model.stan` (which you can dowload [here](https://raw.githubusercontent.com/michael-franke/intro-data-analysis/master/models_stan/binomial.stan)) in a folder `models_stan` and then use the function `rstan::stan` to run the Stan code from within R.
